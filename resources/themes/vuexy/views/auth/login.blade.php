<x-layout-auth>
    ...
    <style>
      ...
      .login-cover-panel .auth-illustration {
        width: min(88%, 980px);
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-xl-flex col-xl-8 p-0">
          <div class="auth-cover-bg login-cover-panel d-flex justify-content-center align-items-center">
            @php
              $loginIllustrationPath = config('config.login_illustration_path');
              $loginIllustration = config('config.login_illustration_path')
                  ? url('/' . ltrim($loginIllustrationPath, '/')) . '?v=' . (@filemtime(public_path($loginIllustrationPath)) ?: time())
                  : asset('img/illustrations/boy-with-laptop-light.png');
            @endphp
            <img
