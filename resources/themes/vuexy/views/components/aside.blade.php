...
@endphp
	<style>
		...
		#layout-menu .app-brand-logo.demo .brand-logo-image {
	...
	<!-- Menu -->
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
          ...
          <ul class="menu-inner py-1">
			...
			<li class="menu-item {{ request()->routeIs('whatsapp.channels.*') || request()->routeIs('devices') ? 'active' : '' }}">
              <a href="{{ route('whatsapp.channels.index') }}" class="menu-link">
			...
			<li class="menu-item {{ request()->routeIs('campaigns') || request()->routeIs('messages.history') || request()->routeIs('analytics.reports') ? 'open active' : 'open' }}">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('analytics.reports') ? 'active' : '' }}">
                  <a href="{{ route('analytics.reports') }}" class="menu-link">
                    <div data-i18n="Analytics and Reports">Analitik & Laporan</div>
                  </a>
                </li>
              </ul>
            </li>
			...
			@if(config('config.show_user_plans_menu', 'true') == 'true')
			...
			<li class="menu-item {{ request()->routeIs('admin.live-chat-monitor') ? 'active' : '' }}">
              <a href="{{ route('admin.live-chat-monitor') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-messages"></i>
                <div data-i18n="Live Chat Monitor">Monitor Chat</div>
              </a>
            </li>
			...
			<li class="menu-item {{ request()->routeIs('admin.esms-integration') ? 'active' : '' }}">
              <a href="{{ route('admin.esms-integration') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-plug-connected"></i>
                <div data-i18n="e-SMS Integration">Integrasi e-SMS</div>
              </a>
            </li>
			<li class="menu-item {{ request()->routeIs('admin.live-chat-monitor') ? 'active' : '' }}">
              <a href="{{ route('admin.live-chat-monitor') }}" class="menu-link">
