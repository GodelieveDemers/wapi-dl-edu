...
Route::get('/meta-whatsapp/webhook', [MetaWhatsAppWebhookController::class, 'verify'])->name('meta-whatsapp.webhook.verify');
Route::post('/meta-whatsapp/webhook', [MetaWhatsAppWebhookController::class, 'receive'])->name('meta-whatsapp.webhook.receive');

Route::post('/meta/data-deletion', [MetaDataDeletionController::class, 'callback'])->name('meta.data-deletion.callback');
